...
class DialogueBox extends FlxSpriteGroup
{
	...
	public function new(talkingRight:Bool = true, ?dialogueList:Array<String>)
	{
		...
		if (PlayState.SONG.song.toLowerCase()=='headache' || PlayState.SONG.song.toLowerCase()=='nerves' || PlayState.SONG.song.toLowerCase()=='release' || PlayState.SONG.song.toLowerCase()=='fading')
			{
			handSelectgar = new FlxSprite(FlxG.width * 0.9, FlxG.height * 0.9).loadGraphic(Paths.image('weeb/hand_textboxgar'));
			add(handSelectgar);
			}
		if (PlayState.SONG.song.toLowerCase()=='senpai' || PlayState.SONG.song.toLowerCase()=='roses' || PlayState.SONG.song.toLowerCase()=='thorns')
			{
		...
		if (PlayState.SONG.song.toLowerCase()=='headache' || PlayState.SONG.song.toLowerCase()=='nerves' || PlayState.SONG.song.toLowerCase()=='release' || PlayState.SONG.song.toLowerCase()=='fading')
		{
		handSelectgar.antialiasing = true;
		}
	...
	function startDialogue():Void
	{
		...
		switch (curCharacter)
		{
			case 'dad':
				...
				{
					if (PlayState.SONG.song.toLowerCase() == 'senpai'|| PlayState.SONG.song.toLowerCase() == 'headache' || PlayState.SONG.song.toLowerCase()=='nerves' || PlayState.SONG.song.toLowerCase()=='release'|| PlayState.SONG.song.toLowerCase()=='fading') portraitLeft.visible = true;
